        ...
        <div className="grid min-h-0 flex-1 gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch lg:py-10">
          <aside className="hidden flex-col justify-between rounded-[1.8rem] border border-[#F1D8DD] bg-white/70 p-5 shadow-[0_26px_80px_rgba(216,120,141,0.12)] backdrop-blur-xl sm:p-7 lg:flex">
            <div>
              ...
              <h1 className="mt-5 font-display text-4xl leading-[1.04] tracking-normal text-[#4B2838] sm:text-5xl lg:text-6xl">
                Ärliga råd utan köphets.
              </h1>
              <p className="mt-4 max-w-xl text-base leading-7 text-[#6f5a64] sm:text-lg sm:leading-8">
                Beskriv behov, budget eller produkten du undrar över. Elin jämför
                sortimentet och säger till när du kan hoppa över.
              </p>
            </div>

            <div className="mt-7 rounded-[1.2rem] border border-[#F1D8DD] bg-white/78 p-4 text-xs leading-5 text-[#6f5a64]">
              <p>
