...
type KettlebellProductReviewPageProps = {
  pick: KettlebellPick;
  otherPick: KettlebellPick;
};

function buildProductSchema(pick: KettlebellPick) {
  return {
...
export async function KettlebellProductReviewPage({
  pick,
  otherPick,
}: KettlebellProductReviewPageProps) {
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <header className="flex items-center justify-between gap-4">
          ...
          >
            ...
            Tillbaka till kettlebell-guiden
          </Link>
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-line bg-surface/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="editorial-color-kiss font-display text-3xl">
              Amazon Basics vs PROIRON mjuk kettlebell
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-ink-soft">
              Amazon Basics är bäst när du vill ha billig och tålig gjutjärn.
              PROIRON är bättre när du vill skydda golv, minska ljud och börja
              mjukare hemma.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/traning/kettlebell",
              label: "Guide",
              text: "Tillbaka till Elins korta kettlebelljämförelse.",
            },
          ]}
        />
