...
type TraningsbandProductReviewPageProps = {
  pick: TraningsbandPick;
  otherPick: TraningsbandPick;
};

function buildProductSchema(pick: TraningsbandPick) {
  return {
...
export async function TraningsbandProductReviewPage({
  pick,
  otherPick,
}: TraningsbandProductReviewPageProps) {
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <header className="flex items-center justify-between gap-4">
          ...
          >
            ...
            Tillbaka till träningsband-guiden
          </Link>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/traning/traningsband",
              label: "Guide",
              text: "Tillbaka till Elins jämförelse av träningsband.",
            },
          ]}
        />
