...
const pick = hantlarPicks.find(
  (item) => item.path === "/traning/hantlar/proiron-neopren",
);
const pageUrl = `${siteConfig.url}/traning/hantlar/proiron-neopren`;
...
export default function ProironNeoprenHantlarPage() {
  if (!pick) {
    notFound();
  }
