...
export async function HantlarProductReviewPage({
  pick,
  otherPick,
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="editorial-color-kiss font-display text-3xl">
              PROIRON vs SONGMICS hantlar
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              PROIRON är bäst när du vill köpa ett enkelt par i exakt vikt.
              SONGMICS är bättre när du vill ha flera vikter, ställning och ett
              färdigt träningshörn hemma.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/traning/hantlar",
              label: "Guide",
              text: "Tillbaka till Elins korta hanteljämförelse.",
            },
          ]}
        />
