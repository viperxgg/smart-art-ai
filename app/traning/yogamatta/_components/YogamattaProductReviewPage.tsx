...
type YogamattaProductReviewPageProps = {
  pick: YogamattaPick;
  otherPick: YogamattaPick;
};

function buildProductSchema(pick: YogamattaPick) {
  return {
...
export async function YogamattaProductReviewPage({
  pick,
  otherPick,
}: YogamattaProductReviewPageProps) {
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="font-display text-3xl text-[#4B2838]">
              ProSourceFit vs YOGATI yogamatta
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              ProSourceFit är bäst när du vill ha maximal dämpning för knän,
              rygg och golvövningar. YOGATI är bättre när yoga kräver grepp,
              stabilitet och tydligare placering av händer och fötter.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/traning/yogamatta",
              label: "Guide",
              text: "Tillbaka till Elins korta yogamattajämförelse.",
            },
          ]}
        />
