...
type FoamRollerProductReviewPageProps = {
  pick: FoamRollerPick;
  otherPick: FoamRollerPick;
};

function buildProductSchema(pick: FoamRollerPick) {
  return {
...
export async function FoamRollerProductReviewPage({
  pick,
  otherPick,
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <header className="flex items-center justify-between gap-4">
          ...
          >
            ...
            Tillbaka till foam roller-guiden
          </Link>
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="editorial-color-kiss font-display text-3xl">
              BODYMATE vs Elvire foam roller
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              BODYMATE är bäst när du vill ha en fokuserad, slät rulle med fast
              tryck och ryggränna. Elvire passar bättre när du vill ha ett helt
              set med fler verktyg och mer texturerad deep-tissue-känsla.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/traning/foam-roller",
              label: "Guide",
              text: "Tillbaka till Elins korta foam roller-jämförelse.",
            },
          ]}
        />
