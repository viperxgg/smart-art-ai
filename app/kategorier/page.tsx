          ...
          {activeProductCategories.map((category) => {
            ...
            return (
              <Link
                key={category.slug}
                href={category.href}
                className="group rounded-[2rem] border border-line bg-surface/70 p-6 shadow-[0_24px_70px_rgba(185,131,166,0.1)] transition hover:-translate-y-1 hover:bg-surface"
              >
                <span className="grid h-14 w-14 place-items-center rounded-2xl bg-rose/15 text-wine">
