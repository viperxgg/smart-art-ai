...
type LocktangProductReviewPageProps = {
  pick: LocktangPick;
  otherPick: LocktangPick;
};

function buildProductSchema(pick: LocktangPick) {
  return {
...
export async function LocktangProductReviewPage({
  pick,
  otherPick,
}: LocktangProductReviewPageProps) {
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-line bg-surface/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="editorial-color-kiss font-display text-3xl">
              BaByliss C325E vs TYMO CURLPRO
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-ink-soft">
              BaByliss är bäst när du vill ha klassiska lockar till lågt pris.
              TYMO är bättre när du vill ha automatisk styling och slippa
              tekniken.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/skonhet/locktang",
              label: "Guide",
              text: "Tillbaka till Elins korta locktångsjämförelse.",
            },
          ]}
        />
