...
export async function EpilatorProductReviewPage({
  pick,
  otherPick,
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="editorial-color-kiss font-display text-3xl">
              Panasonic ES-EY30 vs Braun Silk-épil 9
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              Båda är starka val, men de löser olika behov: Panasonic är
              värdevalet för de flesta, Braun är premiumvalet för dig som vill
              ha fler tillbehör och en mer påkostad helhet.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/skonhet/epilator",
              label: "Guide",
              text: "Tillbaka till Elins korta epilatorjämförelse.",
            },
          ]}
        />
