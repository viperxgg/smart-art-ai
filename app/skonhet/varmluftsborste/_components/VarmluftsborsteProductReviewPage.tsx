...
type VarmluftsborsteProductReviewPageProps = {
  pick: VarmluftsborstePick;
  otherPick: VarmluftsborstePick;
};

function buildProductSchema(pick: VarmluftsborstePick) {
  return {
...
export async function VarmluftsborsteProductReviewPage({
  pick,
  otherPick,
}: VarmluftsborsteProductReviewPageProps) {
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <header className="flex items-center justify-between gap-4">
          ...
          >
            ...
            Tillbaka till varmluftsborste-guiden
          </Link>
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="font-display text-3xl text-[#4B2838]">
              BaByliss AS126E vs Remington AS7100
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              BaByliss är bäst när du vill ha en mångsidig 4-i-1 för volym,
              brushing och lockar. Remington är bättre när du vill ha lägsta
              priset och stylar kort hår.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/skonhet/varmluftsborste",
              label: "Guide",
              text: "Tillbaka till Elins korta varmluftsborste-jämförelse.",
            },
          ]}
        />
        ...
        <section className="mt-7 rounded-[2rem] border border-[#F1D8DD] bg-white/70 p-6 shadow-[0_24px_70px_rgba(185,131,166,0.1)] md:p-8">
          ...
          <div className="mt-6 grid gap-4">
            {varmluftsborsteFaqItems.map((item) => (
              <details
                key={item.question}
