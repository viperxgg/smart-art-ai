...
type PlattangProductReviewPageProps = {
  pick: PlattangPick;
  otherPick: PlattangPick;
};

function buildProductSchema(pick: PlattangPick) {
  return {
...
export async function PlattangProductReviewPage({
  pick,
  otherPick,
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="mt-7 overflow-hidden rounded-[2rem] border border-[#F1D8DD] bg-white/72 shadow-[0_24px_70px_rgba(185,131,166,0.1)]">
          <div className="p-6 md:p-8">
            <h2 className="font-display text-3xl text-[#4B2838]">
              S8540 vs Mini S2880 - vilken ska du välja?
            </h2>
            <p className="mt-4 max-w-3xl leading-8 text-[#6f5a64]">
              Båda är prisvärda, men valet handlar mindre om hype och mer om
              användning: fullstorlek hemma eller mini för resa och snabba fix.
            </p>
          </div>
        ...
        <RelatedLinks
          links={[
            ...
            },
            {
              href: "/skonhet/plattang",
              label: "Guide",
              text: "Tillbaka till Elins korta plattångsjämförelse.",
            },
          ]}
        />
