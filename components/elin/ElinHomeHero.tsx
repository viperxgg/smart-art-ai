          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {capabilityQuestions.map((question) => (
              <button
                ...
                className="min-h-11 max-w-full rounded-full border border-[#F1D8DD] bg-white/70 px-4 py-2 text-left text-sm font-bold leading-5 text-[#4B2838] shadow-[0_12px_30px_rgba(216,120,141,0.1)] transition hover:-translate-y-0.5 hover:bg-white"
