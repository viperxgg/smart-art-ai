      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        <div className="mb-32">
          ...
          <motion.p
            ...
            className="text-white/80 text-lg md:text-xl font-light font-mono tracking-wide"
          >
            {tr("subtitle")}
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24 mb-32 md:mb-48">
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="flex flex-col items-center">
            ...
            <span className="text-white/80 uppercase tracking-[0.2em] md:tracking-[0.4em] text-[11px] md:text-[12px] font-bold font-mono text-center">{t("hours")}</span>
          </motion.div>
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col items-center">
            ...
            <span className="text-white/80 uppercase tracking-[0.2em] md:tracking-[0.4em] text-[11px] md:text-[12px] font-bold font-mono text-center">{t("people")}</span>
          </motion.div>
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="flex flex-col items-center">
            ...
            <span className="text-white/80 uppercase tracking-[0.2em] md:tracking-[0.4em] text-[11px] md:text-[12px] font-bold font-mono text-center">{t("uptime")}</span>
          </motion.div>
        </div>
