      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch relative">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-bold uppercase tracking-[0.4em] mb-12 font-mono">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-400/10 border border-cyan-400/30 text-cyan-400 text-[10px] font-bold uppercase tracking-[0.4em] mb-12 font-mono shadow-[0_0_20px_rgba(0, 229, 255, 0.2)]">
               <Terminal className="w-3 h-3" />
               {t("after_label")}
            </div>
