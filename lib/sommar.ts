...
export const sommarPicks: SommarPick[] = [
  ...
  },
  {
    ...
    cardBadge: "Rengöring",
    cardHook: "Rengöring med glycerin, niacinamid och pantenol enligt den svenska tillverkarsidan. Butikens förpackningsvariant återstår att kontrollera.",
    cardImage: "/products/cetaphil-cleanser/cetaphil-thumbnail.webp",
    cardImageAlt: "Cetaphil Gentle Skin Cleanser, 460 ml",
    badge: "Tillverkaruppgifter",
    headline: "Cetaphil Gentle Skin Cleanser",
    shortBody: "Rengöring med glycerin, niacinamid och pantenol enligt den svenska tillverkarsidan. Butikens förpackningsvariant återstår att kontrollera.",
    valueHook: "Vad behöver din rengöring göra?",
    valueStatement: "Utgå från det som redan fungerar. Tillverkaruppgifter beskriver innehåll och avsedd användning, men avgör inte vilken produkt din hud föredrar.",
    passFor: ["Vill jämföra en ersättare till nuvarande rengöring."],
    caution: "Den faktiska butiksförpackningens formula och volym måste kontrolleras. Vi har inte testat produkten på hud.",
    usageGuidance: { title: "Användning", text: "Följ anvisningarna på den faktiska förpackningen." },
    verdict: "Byt inte en fungerande rengöring enbart för ett nytt varumärke.",
    amazonSummary: "Aktuella Amazon-omdömen har inte verifierats.",
    amazonQuotes: [],
    faqItems: [],
    ...
    metaTitle: "Cetaphil Gentle Skin Cleanser – underlag och köpbeslut | Elins val",
    metaDescription: "Rengöring med glycerin, niacinamid och pantenol enligt den svenska tillverkarsidan. Butikens förpackningsvariant återstår att kontrollera.",
    relatedLinks: [{ href: "/skonhet/cerave-eller-cetaphil", label: "Jämför rengöringarna", text: "Källor, skillnader och begränsningar." }],
  },
  {
  ...
  },
  {
    ...
    href: "/skonhet/cerave-rengoring",
    cardBadge: "Rengöring",
    cardHook: "Rengöring med ceramider och hyaluronsyra enligt tillverkaren. Den svenska formulan är granskad; butikens förpackningsvariant återstår att kontrollera.",
    ...
    badge: "Tillverkaruppgifter",
    headline: "CeraVe Hydrating Cleanser",
    shortBody: "Rengöring med ceramider och hyaluronsyra enligt tillverkaren. Den svenska formulan är granskad; butikens förpackningsvariant återstår att kontrollera.",
    valueHook: "Vad behöver din rengöring göra?",
    valueStatement: "Utgå från det som redan fungerar. Tillverkaruppgifter beskriver innehåll och avsedd användning, men avgör inte vilken produkt din hud föredrar.",
    passFor: ["Vill jämföra en ersättare till nuvarande rengöring."],
    caution: "Den faktiska butiksförpackningens formula och volym måste kontrolleras. Vi har inte testat produkten på hud.",
    ...
    metaTitle: "CeraVe Hydrating Cleanser – underlag och köpbeslut | Elins val",
    metaDescription: "Rengöring med ceramider och hyaluronsyra enligt tillverkaren. Den svenska formulan är granskad; butikens förpackningsvariant återstår att kontrollera.",
    relatedLinks: [{ href: "/skonhet/cerave-eller-cetaphil", label: "Jämför rengöringarna", text: "Källor, skillnader och begränsningar." }],
  },
  {
