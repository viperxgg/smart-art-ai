...
export const smartSommarPicks: SommarPick[] = ([
  ...
  },
  {
    ...
    cardBadge: "Kontrollera före köp",
    cardHook: "Jämför användningen först. Katalogposten säger 2 L med tidsmarkeringar, ASIN B0BVB3GDHG. Vi har inte verifierat volym, material, temperaturgräns, lock, täthet eller skötselråd i aktuell produktdokumentation.",
    cardImage: "/products/twsoul-bottle/bottle-thumbnail.webp",
    cardImageAlt: "TWSOUL motiverande vattenflaska 2 L, tidsmarkerad",
    badge: "Produktguide",
    headline: "TWSOUL vattenflaska",
    shortBody: "Jämför användningen först. Katalogposten säger 2 L med tidsmarkeringar, ASIN B0BVB3GDHG. Vi har inte verifierat volym, material, temperaturgräns, lock, täthet eller skötselråd i aktuell produktdokumentation.",
    valueHook: "Behöver du funktionen?",
    valueStatement: "Katalogposten säger 2 L med tidsmarkeringar, ASIN B0BVB3GDHG. Vi har inte verifierat volym, material, temperaturgräns, lock, täthet eller skötselråd i aktuell produktdokumentation.",
    passFor: ["du vill jämföra en större flaska utan krav på verifierad isolering och först kan kontrollera volym, lock och skötsel hos säljaren. Detta är ett villkor för fortsatt jämförelse, inte en rekommendation av den obekräftade modellen."],
    caution: "du behöver varm dryck, säker packning i väskan eller maskindisk utan att först kunna bekräfta att just flaskan är avsedd för det.",
    usageGuidance: {"title":"Kontrollera rätt instruktion","text":"Vi saknar temperaturgräns och skötselanvisning för den exakta varianten. Använd inte generella flaskråd som modellspecifik instruktion."},
    verdict: "Ingen allmän vinnare eller individuell rekommendation om vätskeintag.",
    amazonSummary: "Aktuella kundbetyg är inte verifierade.",
    amazonQuotes: [],
    faqItems: [{"question":"Behöver jag en termos för vanligt vatten?","answer":"Bara om du behöver isolering eller någon annan särskild funktion. Om du är nöjd med temperaturen och kan fylla på fungerar den flaska eller det glas du redan har som utgångspunkt."},{"question":"Visar tidsmarkeringarna hur mycket jag bör dricka?","answer":"Nej, en tryckt skala är inte ett personligt vätskeråd. Vi har inget test som visar att TWSOUL förbättrar dryckesvanor och rekommenderar inte att alla följer samma volym eller tidsschema."},{"question":"Kan båda diskas i maskin?","answer":"Stanley anger maskindisk för den dokumenterade Classic Legendary Bottle 1,0 L. Det bevisar inte vad som gäller äldre varianter eller TWSOUL. Följ instruktionerna för den produkt du faktiskt har."},{"question":"Kan jag använda TWSOUL till varm dryck?","answer":"Det kan vi inte bekräfta. Vi saknar aktuell temperaturgräns och materialdokumentation och ger därför inget sådant användningsråd."}],
    ...
    metaTitle: "TWSOUL vattenflaska | Elins val",
    metaDescription: "TWSOUL vattenflaska: modell, material och skötsel är ännu inte verifierade. Vad behöver du kontrollera före köp?",
    relatedLinks: [{"href":"/halsa/termos-eller-vattenflaska","label":"Jämför funktion","text":"Isolering eller ett kärl att fylla på?"}],
  },
  {
    ...
    href: "/halsa/termos",
    cardBadge: "Kontrollera före köp",
    cardHook: "Jämför användningen först. EU-sidans Hammertone Green, SKU 100000127613. Inte 0,94 L eller andra storlekar i serien. Katalogens ASIN B000T21JFE är inte matchad mot denna aktuella variant.",
    cardImage: "/products/stanley-termos/termos-thumbnail.webp",
    cardImageAlt: "Stanley Classic termos 1,0 L",
    badge: "Produktguide",
    headline: "Stanley Classic Legendary Bottle – 1,0 L",
    shortBody: "Jämför användningen först. EU-sidans Hammertone Green, SKU 100000127613. Inte 0,94 L eller andra storlekar i serien. Katalogens ASIN B000T21JFE är inte matchad mot denna aktuella variant.",
    valueHook: "Behöver du funktionen?",
    valueStatement: "EU-sidans Hammertone Green, SKU 100000127613. Inte 0,94 L eller andra storlekar i serien. Katalogens ASIN B000T21JFE är inte matchad mot denna aktuella variant.",
    passFor: ["du behöver vakuumisolering och vill hälla drycken i en separat kopp. Tillverkaren anger dubbelväggad konstruktion och ett isolerat lock som också är kopp."],
    caution: "du främst behöver en lätt flaska för korta turer och inte behöver isolering. Tillverkaren anger 807 g redan utan dryck; kontrollera platsen i väskan.",
    usageGuidance: {"title":"Kontrollera rätt instruktion","text":"Stanley anger maskindisk för den lästa EU-varianten. Kontrollera märkning och instruktion för din egen flaska."},
    verdict: "Ingen allmän vinnare eller individuell rekommendation om vätskeintag.",
    amazonSummary: "Aktuella kundbetyg är inte verifierade.",
    amazonQuotes: [],
    faqItems: [{"question":"Behöver jag en termos för vanligt vatten?","answer":"Bara om du behöver isolering eller någon annan särskild funktion. Om du är nöjd med temperaturen och kan fylla på fungerar den flaska eller det glas du redan har som utgångspunkt."},{"question":"Visar tidsmarkeringarna hur mycket jag bör dricka?","answer":"Nej, en tryckt skala är inte ett personligt vätskeråd. Vi har inget test som visar att TWSOUL förbättrar dryckesvanor och rekommenderar inte att alla följer samma volym eller tidsschema."},{"question":"Kan båda diskas i maskin?","answer":"Stanley anger maskindisk för den dokumenterade Classic Legendary Bottle 1,0 L. Det bevisar inte vad som gäller äldre varianter eller TWSOUL. Följ instruktionerna för den produkt du faktiskt har."},{"question":"Kan jag använda TWSOUL till varm dryck?","answer":"Det kan vi inte bekräfta. Vi saknar aktuell temperaturgräns och materialdokumentation och ger därför inget sådant användningsråd."}],
    ...
    metaTitle: "Stanley Classic Legendary Bottle – 1,0 L | Elins val",
    metaDescription: "Stanley Classic Legendary Bottle 1,0 L: isolering, kopplock och vikt enligt tillverkaren. Läs begränsningarna och kontrollera rätt butiksvariant.",
    relatedLinks: [{"href":"/halsa/termos-eller-vattenflaska","label":"Jämför funktion","text":"Isolering eller ett kärl att fylla på?"}],
  },
  {
