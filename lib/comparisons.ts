...
export const comparisonEntries: readonly ComparisonEntry[] = [
  ...
  },
  {
    ...
    shortTitle: "Vilken nattrutin passar dig?",
    category: "skonhet",
    categoryLabel: "Skönhet",
    href: "/skonhet/satinmossa-eller-sidenorngott",
    description: "Samla håret eller byt örngott: jämför komfort, mått, paketantal och skötsel utan löften om bättre hud.",
  ...
  },
  {
    ...
    shortTitle: "Vilken lockmetod passar dig?",
    category: "skonhet",
    categoryLabel: "Skönhet",
    href: "/skonhet/heatless-lockar-eller-locktang",
    description: "Väntetid med Kitsch-setet eller aktiv styling med BaByliss: kontrollera innehåll, instruktioner och modell.",
