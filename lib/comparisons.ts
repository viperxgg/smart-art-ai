...
export const comparisonEntries: readonly ComparisonEntry[] = [
  ...
  },
  {
    ...
    category: "traning",
    categoryLabel: "Träning",
    href: "/traning/handledslindor-eller-lyftremmar",
    description: "Stöd för handleden vid press eller grepphjälp vid drag – köp rätt.",
    productSlugs: ["asipro-handledslindor","fitgriff-lifting-straps"],
  ...
  },
  {
    ...
    title: "Azelainsyra eller AHA/BHA?",
    shortTitle: "Azelainsyra eller AHA/BHA",
    category: "skonhet",
    categoryLabel: "Skönhet",
  ...
  },
  {
    ...
    title: "Centella eller propolis?",
    shortTitle: "Centella eller propolis",
    category: "skonhet",
    categoryLabel: "Skönhet",
  ...
  },
  {
    ...
    title: "Tyngdväst eller lyftarbälte?",
    shortTitle: "Tyngdväst eller lyftarbälte",
    category: "traning",
    categoryLabel: "Träning",
    href: "/traning/tyngdvast-eller-lyftarbalte",
    description: "Västen som gör kroppen tyngre mot bältet som stöttar tunga lyft – Elin reder ut vilket redskap din träning faktiskt behöver.",
    productSlugs: ["eric-flag-viktvast","cpsports-lyftarbalte"],
  ...
  },
  {
    ...
    title: "Cicaplast B5 eller Cetaphil?",
    shortTitle: "Cicaplast B5 eller Cetaphil",
    category: "skonhet",
    categoryLabel: "Skönhet",
  ...
  },
  {
    ...
    title: "Magnetisk mobilhållare eller ventilklämma?",
    shortTitle: "Magnetisk hållare eller ventilklämma",
    category: "resa",
    categoryLabel: "Resa",
    href: "/sommar/resa/magnetisk-mobilhallare-eller-ventilklamma",
    description: "MagSafe-magnetens en-handsgrepp mot klämman som passar alla mobiler – Elin reder ut valet inför semesterkörningen.",
    productSlugs: ["lamicall-mobilhallare-bil","blukar-mobilhallare-ventil"],
    badges: ["Road trip","Navigering","Sommar"],
  },
  {
    slug: "loparvast-eller-midjevaska",
    title: "Löparväst eller midjeväska?",
    shortTitle: "Löparväst eller midjeväska",
    category: "traning",
    categoryLabel: "Träning",
    href: "/traning/loparvast-eller-midjevaska",
    description: "Bältet som räcker för vardagsrundan mot västen som bär vattnet på långpassen – Elin säger ärligt vilken du behöver.",
    productSlugs: ["haissky-loparbalte","salomon-loparvast"],
    badges: ["Löpning","Sommarrundor","Budget vs premium"],
  },
  {
    slug: "mjuk-kylvaska-eller-hard-kylbox",
    title: "Mjuk kylväska eller hård kylbox?",
    shortTitle: "Mjuk kylväska eller hård kylbox",
    category: "resa",
    categoryLabel: "Resa",
    href: "/sommar/resa/mjuk-kylvaska-eller-hard-kylbox",
    description: "Kylryggsäcken som bärs bekvämt mot boxen som håller kylan i dagar – Elin reder ut vilken som passar din sommarutflykt.",
    productSlugs: ["lifewit-kylvaska","coleman-xtreme-kylbox"],
    badges: ["Strand & picknick","Camping","Sommar"],
  },
  {
    slug: "olaplex-eller-harinpackning",
    title: "Olaplex eller hårinpackning – värt det?",
    shortTitle: "Olaplex eller hårinpackning",
    category: "skonhet",
    categoryLabel: "Skönhet",
    href: "/skonhet/olaplex-eller-harinpackning",
    description: "Bond-kuren mot den klassiska inpackningen – Elin reder ut vad ditt hår faktiskt behöver och när hypen är värd pengarna.",
    productSlugs: ["olaplex-no3-treatment","loreal-absolut-repair"],
