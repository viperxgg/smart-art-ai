...
export const brynserumEllerBrynlamineringComparisonRows = [["Snabba signaler","Dagligt serum; fylligt uttryck med tiden","Kit som sätter håren; fyllig look direkt"],["Resultat","Gradvis, med daglig användning","Direkt, håller i veckor"],["Insats","Enkel daglig rutin","Ett par steg med kit"],["Håller","Så länge du fortsätter","Ofta några veckor per laminering"],["Bäst för","Långsiktigt uttryck","Fyllig look inför tillfällen"],["Nybörjarvänligt","Mycket","Bra – följ stegen noga"],] as const;
