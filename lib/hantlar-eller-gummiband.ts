...
export const hantlarEllerGummibandDecision: DecisionRecord = {
  ...
  options: [
    { productSlug: "proiron-neoprenhantlar", model: "PROIRON PRKNED02K – 2 × 2 kg", variant: "Referens: PRKNED02K, äppelgrönt par med två fasta 2 kg-hantlar, totalt 4 kg. Amazon.se visar ASIN B01C9MU966 efter omdirigering från katalogens B01BEVZZZS. Den befintliga korta affiliatelänkens mål är ännu inte kontrollerat.", chooseIf: "du behöver två fasta 2 kg-hantlar för dina övningar. Paketets sammanlagda 4 kg betyder inte att varje hantel väger 4 kg.", avoidIf: "du vill ändra vikten på samma hantel med lösa skivor. Då behöver du jämföra ett justerbart redskap i stället.", sourceIds: ["T1", "T3"], merchantVariantVerified: false },
    { productSlug: "elvire-miniband", model: "Elvire Sport LD40 – Short Blue and Black", variant: "Amazon.se listar LD40, ASIN B07NK18M4J: tre korta band i blått/svart, tre motståndsnivåer, mått 36 × 8,1 cm och bärpåse. Exakt töjningsmått och full materialsammansättning är inte bekräftade. Den korta affiliatelänken återstår att kontrollera.", chooseIf: "din övning kräver ett kort band och du först kan kontrollera att längd och motstånd passar. Butikens tre motståndsnivåer är inte en verifierad belastning i kilogram.", avoidIf: "du söker ett långt band för en övning med handtag eller dörrfäste, eller behöver bekräftad materialsammansättning som vi saknar.", sourceIds: ["T2", "T4"], merchantVariantVerified: false },
  ],
