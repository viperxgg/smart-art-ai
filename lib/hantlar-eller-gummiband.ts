...
export const hantlarEllerGummibandDecision: DecisionRecord = {
  ...
  sources: [
    { id: "T1", title: "PROIRON – hantelsortiment", url: "https://proiron.com/collections/dumbbell", checkedAt: "2026-09-09", supports: "Vid kontrollen 2026-09-08 listade tillverkaren neoprenhantlar separat från justerbara hantelset; vid ny läsning 2026-09-09 visade sidan inga produkter. Ingen exakt svensk köpvariant har matchats." },
