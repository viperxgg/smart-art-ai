...
export const luftkylareEllerFlaktRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/halsa/luftrenare","label":"Luftrenare","text":"Bättre inomhusluft: Elins val av luftrenare."},{"href":"/halsa/luftkylare","label":"Luftkylare","text":"Läs Elins recension av Beurer LV 50 luftkylare."},{"href":"/halsa/bordsflakt","label":"Fläkt","text":"Läs Elins recension av Xiaomi bordsfläkt."},{"href":"/halsa/tornflakt-eller-bordsflakt","label":"Jämförelse","text":"Tornfläkt eller bordsfläkt? Se den jämförelsen."},{"href":"/halsa/flakt","label":"Fläkt","text":"Se alla Elins fläktar för sommaren."}];
