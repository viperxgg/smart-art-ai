...
export const footPeelEllerElektriskFotfilComparisonRows = [["Snabba signaler","Huden flagnar av sig själv över tid","Filar bort hård hud direkt"],["Resultat","Djupare, jämnare","Snabbt och kontrollerat"],["Tid","Flagnar under 1–2 veckor","Klart på några minuter"],["Flagningsperiod?","Ja – planera i tid","Nej"],["Underhåll","Några gånger per säsong","Lite då och då"],["Bäst inför","Sommaren, med framförhållning","Snabb koll innan sandalerna"],] as const;
