...
export const lyftremmarEllerTraningshandskarComparisonRows = [["Snabba signaler","Avlastar greppet vid tunga lyft","Skyddar händerna; stadigare grepp"],["Bäst för","Marklyft, rodd, tunga drag","Allmän träning, handskydd"],["Löser","Greppet ger upp före musklerna","Skavsår och valkar"],["När","De tyngsta lyften","Vardagsträning"],["Passform","Runt handled och stång","På händerna"],["Nybörjarvänligt","Bra – lär dig tekniken","Ja"],] as const;
