...
export const hangandeEllerGenomskinligNecessarComparisonRows = [["Snabba signaler","Hängs på krok; nå allt utan att rota","Genomskinlig; se innehållet direkt"],["Bäst för","Ordning på hotellbadrummet","Säkerhetskontroll och smått"],["Storlek","Rymlig, blir stor fullpackad","Mindre, för smått"],["Ser du innehållet?","Delvis, via fack","Ja – helt genomskinlig"],["Antal","En necessär","Set med flera storlekar"],["Bäst tillsammans","Ja – för det mesta","Ja – för vätskorna"],] as const;
