...
export const bronzerEllerBrunUtanSolComparisonRows = [["Snabba signaler","Glow i kräm; tvättas av","Utvecklas till färg som håller"],["Håller","Tills du tvättar av (samma dag)","Flera dagar"],["Styr intensitet","Ja – doseras i kräm","Delvis – via lagertjocklek"],["Applicering","Bland i din kräm/foundation","Applicera med vante på ren hud"],["Bäst för","Snabb glow inför en dag","Hållbar färg inför tillfällen"],["Nybörjarvänligt","Mycket","Bra – exfoliera först"],] as const;
