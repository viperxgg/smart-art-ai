...
export const groomingOverview: DecisionGuide = {
  ...
  intro: "Vill du behålla en skägglängd, forma stubb eller raka ansiktet? Börja med det du saknar i din rutin. Här finns underlag för tre Philips-modeller och Remington HC5035 för hemmaklippning. Skäggolja och nästrimmer är ännu inte tillräckligt granskade för en rekommendation.",
  decision: {
    reviewedAt: "2026-09-09",
    options: [...groomingDecision.options, shaverDecision.options[0], ...hairClipperDecision.options],
    ...
    testing: "Detta är en sammanställning av dokumenterade modelluppgifter från jämförelserna och HC5035-manualen. Vi har inte utfört egen rakning eller provat hudkomfort, livslängd eller kostnad över tid.",
    limitations: "Två av de sex produkterna i den här guiden saknar ännu tillräckligt granskat underlag: L’Oréal skäggolja och WINSEA nästrimmer. Länkarna nedan finns kvar för orientering och innebär ingen rekommendation. Bilder och butiksmatchning återstår även för de granskade modellerna.",
    sources: [...groomingDecision.sources, ...shaverDecision.sources.filter(source => source.id !== "G1"), ...hairClipperDecision.sources],
  },
  productPaths: ["/skonhet/grooming/oneblade-360", "/skonhet/grooming/philips-skaggtrimmer", "/skonhet/grooming/philips-rakapparat", "/skonhet/grooming/remington-harklippare"],
  questions: [
    ...
    { question: "Är alla sex produkter rekommenderade?", answer: "Nej. Vi har dokumenterade modelluppgifter för de tre Philips-verktygen och HC5035, med begränsningar. Skäggoljan och nästrimmern är inte tillräckligt granskade för att vi ska rekommendera ett köp." },
