...
export const sminksvampEllerSminkborsteComparisonRows = [["Snabba signaler","Klappar in; naturlig, hudlik finish","Bygger täckning snabbt och jämnt"],["Finish","Fräsch och naturlig","Jämn och mer täckande"],["Produktåtgång","Suger upp lite mer produkt","Tar mindre produkt"],["Snabbhet","Lite mer pillande","Snabbt"],["Rengöring","Tvätta ofta – fuktig miljö","Tvätta regelbundet"],["Bäst för","Naturlig vardagslook","Täckande look eller bråttom"],] as const;
