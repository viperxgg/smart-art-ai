...
export const billaddareEllerPowerbankRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/sommar/resa/billaddare","label":"Billaddare","text":"Läs Elins recension av INIU billaddare."},{"href":"/sommar/resa/powerbank","label":"Powerbank","text":"Läs Elins recension av Anker Zolo powerbank."},{"href":"/sommar/resa/powerbank-eller-vaggladdare","label":"Jämförelse","text":"Powerbank eller väggladdare? Se den jämförelsen."},{"href":"/halsa/linocell-carplay-adapter","label":"Linocell CarPlay-adapter","text":"Behöver du trådlös CarPlay på bilresan? Kontrollera bilens kompatibilitet först."},{"href":"/sommar/resa","label":"Resa","text":"Se alla Elins smarta reseprylar."}];
