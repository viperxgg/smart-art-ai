...
export const varmedynaEllerMassagekuddeComparisonRows = [["Snabba signaler","Sprider mjuk värme; avslappnande","Knådar med roterande noder; aktiv"],["Typ","Passiv värme","Aktiv massage"],["Bäst för","Lugn och nedvarvning","Bearbeta spända muskler"],["Känsla","Mjuk och skön","Kraftigare knådning"],["Har värme?","Ja – huvudfunktion","Ofta som tillägg"],["När","Kväll och avkoppling","Efter stel dag eller träning"],] as const;
...
export const varmedynaEllerMassagekuddeRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/halsa/tyngdtacke","label":"Tyngdtäcke","text":"För lugn och återhämtning: Elins val av tyngdtäcke."},{"href":"/halsa/varmedyna","label":"Värmedyna","text":"Läs Elins recension av Beurer värmedyna."},{"href":"/halsa/massagekudde","label":"Massagekudde","text":"Läs Elins recension av RENPHO massagekudde."},{"href":"/halsa/massagepistol-eller-spikmatta","label":"Jämförelse","text":"Massagepistol eller spikmatta? Se den jämförelsen."},{"href":"/halsa","label":"Hälsa","text":"Se alla Elins val för återhämtning."}];
