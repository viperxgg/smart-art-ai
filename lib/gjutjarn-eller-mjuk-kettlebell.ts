...
export const gjutjarnEllerMjukKettlebellComparisonRows = [["Snabba signaler","Solid gjutjärn; texturerat grepp","Sandfylld; mjukt hölje"],["Känsla","Tät, klassisk järnkänsla","Mjukare, lite större kropp"],["Golv & ljud","Kräver matta eller tåligt golv","Snäll mot parkett, tyst nedsättning"],["Bäst för","Källare, garage, van lyftare","Lägenhet, nybörjare, barn i hemmet"],["Vikter","Flera steg att växa i","Lättare spann, mjukare start"],["Hållbarhet","Tål i princip allt","Höljet ska inte släpas på asfalt"],] as const;
