...
export const magnetiskMobilhallareEllerVentilklammaRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/sommar/resa/mobilhallare","label":"MagSafe","text":"Läs Elins genomgång av Lamicall magnethållare."},{"href":"/sommar/resa/mobilhallare-ventil","label":"Klämma","text":"Läs Elins genomgång av Blukar klämhållare."},{"href":"/sommar/resa/billaddare","label":"Billaddare","text":"Ladda mobilen medan du navigerar."},{"href":"/halsa/linocell-carplay-adapter","label":"Linocell CarPlay-adapter","text":"Vill du även slippa kabeln till CarPlay? Kontrollera bilens kompatibilitet först."},{"href":"/sommar/resa","label":"Resa","text":"Se alla Elins val för resan."}];
