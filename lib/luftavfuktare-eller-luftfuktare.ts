...
export const luftavfuktareEllerLuftfuktareComparisonRows = [["Gör vad?","Drar fukt ur luften och samlar i tank","Tillför fukt via fin mist"],["Problemet den löser","Imma, fuktlukt, tvätt som inte torkar","Torr luft, statisk elektricitet, torra luftvägar"],["Bäst säsong","Höst och regnperioder","Vinter när elementen är på"],["Bäst rum","Badrum, källare, tvättstuga, sovrum","Sovrum och vardagsrum"],["Skötsel","Töm tanken, rengör filtret ibland","Fyll på vatten, rengör tanken regelbundet"],["Ljudnivå","Jämnt lågt brus","Mycket tyst på lägsta läget"],] as const;
