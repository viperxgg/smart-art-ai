...
export const texturaprayEllerVolympuderComparisonRows = [["Snabba signaler","Grepp och matt textur i hela håret","Snabbt lyft och volym vid rötterna"],["Bäst för","Beach-look, uppsatt hår, håll","Platt hår som behöver rotvolym"],["Var i håret","Hela längden","Vid rötterna"],["Känsla","Matt, sladdrig struktur","Volym och grepp vid rötterna"],["Applicering","Spraya och skrynkla in","Strö och massera in"],["Bäst för uppsatt hår","Ja – ger grepp","Ja – lyft vid fästet"],] as const;
