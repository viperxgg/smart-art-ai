...
export const mjukKylvaskaEllerHardKylboxComparisonRows = [["Snabba signaler","Kylryggsäck; lätt att bära; kyla i timmar","Hård box; kyla i dagar; tål att sittas på"],["Bäst för","Dagsutflykt till fots eller cykel","Camping, festival och bilpackning"],["Kyltid","Timmar – med frysta kylklampar","Upp till 4 dagar med rätt packning"],["Att bära","Bekvämt på ryggen, händerna fria","5,5 kg tom – helst bilen eller två som bär"],["Volym","24 liter","49 liter"],["Extra","Viks ihop platt hemma","Funkar som sittplats, tål 113 kg"],] as const;
