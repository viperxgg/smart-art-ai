...
export const tangleTeezerEllerHarborsteComparisonRows = [["Snabba signaler","Korta borst i olika längder; glider","Mjuka, fjädrande borst; snällt mot blött"],["Bäst för","Allround, torrt och fuktigt hår","Blött hår och känslig hårbotten"],["Form","Kompakt, greppvänlig","Klassisk borstform"],["Drag i håret","Litet","Väldigt litet på blött hår"],["Ta med i väskan","Ja – liten","Något större"],["Snällare än hård borste","Ja","Ja"],] as const;
