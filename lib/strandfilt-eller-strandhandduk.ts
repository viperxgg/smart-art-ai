...
export const strandfiltEllerStrandhanddukComparisonRows = [["Snabba signaler","Stor sandfri sittyta; 300x300 cm","Mjuk frotté; torkar dig"],["Bäst för","Sitta/ligga, hela sällskapet","Torka sig, svepa in sig"],["Sandfri","Ja – sanden borstas av","Nej – frotté samlar sand"],["Personlig eller gemensam","Gemensam bas","Personlig"],["Torkar dig","Nej","Ja"],["Packmått","Viks litet med påse","Skrymmer mer (4-pack)"],] as const;
