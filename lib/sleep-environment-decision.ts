...
export const sleepEnvironmentDecision: DecisionRecord = {
  ...
  options: [
    ...
    { productSlug: "magicteam-white-noise", model: "Magicteam ljudmaskin – variant ej verifierad",
      variant: "Katalogpost ASIN B07RQWQBXY. Uppgiften 40 ljud, timer, minne och strömförsörjning är inte verifierad mot en modellbunden manual.",
      chooseIf: "du vill undersöka bakgrundsljud som funktion och först kan kontrollera exakt modell, volymreglage och avstängning. Vi rekommenderar inte den här produktposten innan det är gjort.",
      avoidIf: "du förväntar dig att apparaten tar bort bullret i rummet eller att fler ljud automatiskt ger bättre sömn. Sådana resultat är inte verifierade här.", sourceIds: ["N1"], merchantVariantVerified: false },
  ...
  testing: "Vi har läst Mantas produktsida och 1177:s information för vuxna. Vi har inte testat ljusläckage, tryck mot ansiktet, ljudmaskering, täckets komfort eller sömnresultat. Magicteam- och Ella-sidorna kunde inte läsas vid kontrollen.",
  limitations: "Mantas justeringar är dokumenterade; personlig passform och sömneffekt är inte bevisade. Magicteam och Ella har kvarstående modell- och specifikationsluckor. Inga bilder, svenska erbjudanden eller kombinationer av produkterna är godkända här.",
  sources: [
    ...
    { id: "N1", title: "Amazon – Magicteam-ASIN, ej verifierad", url: "https://www.amazon.se/dp/B07RQWQBXY", checkedAt: "2026-09-09", status: "unavailable", supports: "Läsningen misslyckades. Styrker inte antal ljud, timer, minne eller modell." },
...
export const sleepEnvironmentGuide: DecisionGuide = {
  ...
  questions: [
    ...
    { question: "Har Magicteam-modellen 40 ljud?", answer: "Det står i den äldre katalogen, men modellbunden dokumentation saknas. Vi använder därför inte siffran som skäl att köpa." },
  ...
  related: [
    ...
    { href: "/halsa/white-noise", text: "Magicteam – vad återstår?" },
