...
export const toothbrushDecision: DecisionRecord = {
  ...
  limitations: "Serieuppgifter bevisar inte varje äldre eller nyare handelspaket. Bilder, erbjudanden och personlig lämplighet är inte verifierade. Produktjämförelsen ersätter inte tandvårdens råd vid besvär, implantat eller särskilda behov.",
  sources: [
