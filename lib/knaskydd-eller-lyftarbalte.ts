...
export const knaskyddEllerLyftarbalteRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/traning/knaskydd","label":"Knäskydd","text":"Läs Elins genomgång av Rehband RX 5 mm."},{"href":"/traning/lyftarbalte","label":"Lyftarbälte","text":"Läs Elins genomgång av C.P. Sports T9."},{"href":"/traning/tyngdvast-eller-lyftarbalte","label":"Jämförelse","text":"Tyngdväst eller lyftarbälte – vilket lyfter din träning?"},{"href":"/traning/kettlebell","label":"Kettlebell","text":"Mångsidig styrka och kondition hemma."},{"href":"/traning/handledslindor-eller-lyftremmar","label":"Jämförelse","text":"Handledslindor eller lyftremmar? Press eller drag – köp rätt gymstöd."}];
