...
export const bikinitrimmerEllerRakhyvelComparisonRows = [["Snabba signaler","Trimmar/formar; går inte ända ner","Ger helt slät yta vid ytan"],["Resultat","Kortat och snyggat","Helt slätt"],["Risk för irritation","Låg","Högre – kräver omsorg"],["Förberedelse","Ingen – torrt går bra","Blöt hud och rakgel"],["Rakknottror","Sällan","Möjligt – raka i hårets riktning"],["Bäst för","Snabb koll utan irritation","Helt slät yta"],] as const;
