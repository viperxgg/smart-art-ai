...
export const waveProductPicks: SommarPick[] = [
  ...
  },
  {
    ...
    cardHook: "Behöver du aktivitetsdata på handleden, eller räcker telefonen?",
    cardImage: "/products/xiaomi-smart-band-10/xiaomi-smart-band-10-thumbnail.webp",
    cardImageAlt: "Xiaomi Smart Band 10 – bildrättigheter inte verifierade",
    badge: "Kontrollera telefonberoendet",
    headline: "Xiaomi Smart Band 10 – standardmodell",
    shortBody: "GPS-rutter kräver telefonen. Kontrollera app, passform och funktioner före köp.",
    valueHook: "Vad vill du följa?",
    valueStatement: "Underlaget bygger på Xiaomis produkt- och supportsidor, inte egna mätningar.",
    passFor: ["Du vill ha information på handleden och kan ta med telefonen för ruttregistrering."],
    caution: "Ingen egen GPS; funktionerna är inte avsedda för medicinska ändamål.",
    usageGuidance: { title: "Kontrollera före köp", text: "Mi Fitness, din telefonversion, handledsmått och exakt handelspaket." },
    verdict: "Behåll det du har om det redan ger den översikt du använder.",
    amazonSummary: "Aktuella kundomdömen och erbjudanden har inte verifierats.",
    amazonQuotes: [],
    faqItems: [
      { question: "Kan jag lämna telefonen hemma?", answer: "Bandet saknar egen GPS. Ruttregistrering kräver telefonen och dess positionstjänster." },
      { question: "Har ni testat mätvärdena?", answer: "Nej. Vi har inte provat puls, sömn, distans, app eller batteritid." },
    ],
    ...
    metaTitle: "Xiaomi Smart Band 10 – behöver du ett aktivitetsband?",
    metaDescription: "Telefonberoende, passform, funktioner och begränsningar före köp av Xiaomi Smart Band 10.",
    relatedLinks: [{ href: "/traning", label: "Träning", text: "Börja med vad du behöver i din träning." }],
  },
  {
    ...
    cardBadge: "Beslutsunderlag",
    cardHook: "Vilken yta behöver skydd, och vilken belastning ska den tåla?",
    cardImage: "/products/bemaxx-pusselmatta/bemaxx-pusselmatta-thumbnail.webp",
    cardImageAlt: "bemaxx EVA golvskydd – bildrättigheter inte verifierade",
    badge: "Kontrollera underlaget",
    headline: "bemaxx EVA golvskydd – 18 delar, 1 cm",
    shortBody: "Ett modulärt underlag behöver matchas mot golvet, utrustningen och monterad yta.",
    valueHook: "Golvskydd är inte en ljudgaranti",
    valueStatement: "Tillverkaruppgifter och allmän bruksanvisning, inga egna belastnings- eller ljudprov.",
    passFor: ["Du behöver ett flyttbart underlag och kan kontrollera att det passar användningen."],
    caution: "Ingen verifierad garanti för tysta hopp eller skydd vid tappade vikter.",
    usageGuidance: { title: "Mät före köp", text: "Ett set anges ge cirka 182 × 92 cm. Kontrollera monterade mått och utrustningens underlagskrav." },
    verdict: "Behåll ett fungerande underlag; köp bara den yta som faktiskt behövs.",
    amazonSummary: "Aktuella kundomdömen och handelspaket har inte verifierats.",
    amazonQuotes: [],
    faqItems: [
      { question: "Gör mattan träningen ljudlös?", answer: "Det har vi inte verifierat. Någon kvantifierad ljudmätning för din utrustning och bostad finns inte i vårt underlag." },
      { question: "Kan jag släppa tunga vikter på den?", answer: "Vi har inget verifierat fallviktsprov eller en säker belastningsgräns för detta set." },
    ],
    ...
    metaTitle: "bemaxx EVA golvskydd – vilket underlag behöver du?",
    metaDescription: "Monterad yta, användning och begränsningar före köp av bemaxx EVA golvskydd.",
    relatedLinks: [{ href: "/traning", label: "Träning", text: "Utgå från aktiviteten och utrustningens krav." }],
  },
  {
...
export const waveGuides: WaveGuide[] = [
  ...
  },
  {
    ...
    href: daylightLampGuide.path, category: "halsa", label: "Jämförelse",
    title: daylightLampGuide.title, intro: daylightLampGuide.intro,
    badges: ["Reglage och placering", "Modellbundna instruktioner"],
    productSlugs: daylightLampGuide.decision.options.map(option => option.productSlug),
    pickBadges: {}, choiceTitle: "Vilka funktioner behöver du?",
    choiceText: daylightLampGuide.decision.payMoreWhen,
    rows: [], verdict: daylightLampGuide.decision.noPurchaseWhen,
    faqItems: [...daylightLampGuide.questions],
    relatedLinks: daylightLampGuide.related.map(link => ({ href: link.href, label: "Läs vidare", text: link.text })),
    metaTitle: "Beurer TL 30 eller TL 35 – reglage och placering | Elins val",
  ...
  {
    id: "sov-battre-i-host", href: sleepEnvironmentGuide.path, category: "halsa", label: "Guide",
    title: sleepEnvironmentGuide.title, intro: sleepEnvironmentGuide.intro, badges: ["Behov före köp"],
    productSlugs: sleepEnvironmentGuide.decision.options.map(option => option.productSlug),
    pickBadges: {}, choiceTitle: "Vad saknar du?", choiceText: sleepEnvironmentGuide.decision.payMoreWhen,
    rows: [], verdict: sleepEnvironmentGuide.decision.noPurchaseWhen, faqItems: [...sleepEnvironmentGuide.questions],
    relatedLinks: sleepEnvironmentGuide.related.map(link => ({ href: link.href, label: "Läs vidare", text: link.text })),
