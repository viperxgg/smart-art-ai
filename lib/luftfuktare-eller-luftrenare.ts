...
export const luftfuktareEllerLuftrenareRelatedLinks: DecisionComparisonRelatedLink[] = [{"href":"/halsa/luftavfuktare","label":"Luftavfuktare","text":"Har du fuktproblem? Se Elins val av luftavfuktare."},{"href":"/halsa/luftfuktare","label":"Luftfuktare","text":"Läs Elins recension av Levoit luftfuktare."},{"href":"/halsa/luftrenare","label":"Luftrenare","text":"Läs Elins recension av Levoit Core 200S."},{"href":"/halsa","label":"Hälsa","text":"Se alla Elins val för smart hem och klimat."},{"href":"/halsa/tornflakt-eller-bordsflakt","label":"Fläkt","text":"Tornfläkt eller bordsfläkt? Se den jämförelsen."},{"href":"/halsa/luftavfuktare-eller-luftrenare","label":"Jämförelse","text":"Luftavfuktare eller luftrenare? Fukt eller partiklar – välj rätt maskin."}];
