...
export const hairMaskDecision: DecisionRecord = {
  ...
  sources: [
    { id: "M1", title: "Moroccanoil Sverige – Intense Hydrating Mask", url: "https://se.moroccanoil.com/products/intense-hydrating-mask", checkedAt: "2026-09-08", supports: "Målgrupp, formula MOIHM03 med parfym och användning efter schampo i 5–7 minuter. Inte ett jämförande effektbevis." },
